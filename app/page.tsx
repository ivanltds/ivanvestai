          ...
          {brlBalance > 0 && (
            <div className="text-right border-r border-neutral-800 pr-6">
              <div className="flex items-center justify-end gap-1.5 mb-1">
                ...
                <p className="text-[10px] text-amber-400 font-bold uppercase tracking-wider font-mono">
                  Saldo BRL
                </p>
              </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`flex items-center text-[10px] ${
                              wentUp ? 'text-emerald-400' : 'text-rose-400'
                            }`}
              ...
              <div className="flex items-center justify-between pb-3 border-b border-neutral-800/60 mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-neutral-400">Fontes globais monitoradas pelos agentes</p>
                  </div>
                </div>

                <span className="text-[10px] font-mono text-neutral-500">Ao vivo</span>
              </div>

              <div className="space-y-2.5 max-h-[360px] overflow-y-auto pr-1.5 custom-scrollbar">
                {auditLogs[0].news_sources.slice(0, 15).map((src: any, idx: number) => {
                  let hostname = 'notícia'
                  try {
                  ...
                  return (
                    <a
                      ...
                      className="block p-3 rounded-xl border border-neutral-850 bg-neutral-950/60 hover:bg-neutral-900 hover:border-neutral-750 transition-all group font-mono"
                    >
                      <p className="text-xs text-neutral-300 group-hover:text-purple-300 transition-colors line-clamp-2 leading-snug font-sans">
                        {src.title}
                      </p>
                      <div className="flex justify-between items-center mt-2 text-[10px] text-neutral-500">
                        <span className="uppercase tracking-wider">{hostname}</span>
                        <ExternalLink className="w-3 h-3 text-neutral-600 group-hover:text-purple-400 transition-colors" />
                      </div>
                    </a>
                  )
                })}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    ...
                    {isLive && (
                      <span className="flex items-center gap-1 px-2 py-0.5 bg-emerald-500/10 text-emerald-400 text-[10px] font-mono font-bold rounded-full border border-emerald-500/30 tracking-wider animate-pulse">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                      {entry.trades.map((t: any, i: number) => {
                        ...
                        return (
                          <div
                            key={i}
                            className={`p-3 rounded-xl border relative overflow-hidden transition-all font-mono text-xs ${
                              !isBuy
                            ...
                            <div className="flex justify-between items-center mb-2">
                              <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-1 text-[11px] font-bold text-neutral-300">
                                  <span className={isBuy ? 'text-amber-400' : 'text-purple-400'}>
                                    {fromAsset}
                                  </span>
