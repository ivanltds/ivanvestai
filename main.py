...
def main():
    ...
    # SNIPER: a partir desta versão, o Sniper Day Trade NÃO é mais executado aqui.
    # Ele é orquestrado pelo run_loop.py em uma thread paralela para não bloquear
    # os ciclos de monitoramento de 15 minutos.
    # Veja: run_loop_sniper() em run_loop.py
